# Optional Lab 13: Manage IOS XE and Build an OSPF Service with Cisco NSO
...
Using VS Code, replace the generated `ospf-service/src/yang/ospf-service.yang` with the supplied file from `CCNPAUTO/LAB/Lab13/packages/ospf-service/src/yang/ospf-service.yang`. Replace the generated XML template with the supplied `CCNPAUTO/LAB/Lab13/packages/ospf-service/templates/ospf-service-template.xml`.
