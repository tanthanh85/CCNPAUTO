...
Create a private GitLab.com project named `optional_lab16_minikube`, clone it under `~/ccnpauto-workspace`, and copy the contents of `CCNPAUTO/LAB/Lab16 - Learn Kubernetes Fundamentals with Minikube/` into it using VS Code.
