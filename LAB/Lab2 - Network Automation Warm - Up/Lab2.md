...
Using the VS Code Explorer, copy and paste the following items from the course folder `CCNPAUTO/LAB/Lab2 - Network Automation Warm - Up/` into the root of the cloned `lab2_warm_up/` repository:
