...
- `iosxe_netconf.py` and `ospf_renderer.py` from `CCNPAUTO/LAB/Lab6 - Configure Network Devices Using NETCONF with YANG/src/` to the project's `src/`;
- `configure_ospf.py` from `CCNPAUTO/LAB/Lab6 - Configure Network Devices Using NETCONF with YANG/scripts/` to `scripts/`;
- `ospf_native.xml.j2` from `CCNPAUTO/LAB/Lab6 - Configure Network Devices Using NETCONF with YANG/templates/` to `templates/`;
- `pytest.ini` from `CCNPAUTO/LAB/Lab6 - Configure Network Devices Using NETCONF with YANG/` to the project root;
- `test_ospf_renderer.py` from `CCNPAUTO/LAB/Lab6 - Configure Network Devices Using NETCONF with YANG/tests/` to the project's `tests/`.
