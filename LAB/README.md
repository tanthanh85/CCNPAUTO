...
flowchart TD
    ...
    L15["Optional Lab 15<br/>C8000V IOx Local Manager"]
...
| `optional_lab15_c8000v_app_hosting` | Optional Lab 15 | C8000V packaging and IOx Local Manager lifecycle |
...
| [Optional Lab 15](Lab15/Lab15.md) | A network team needs an event-driven utility to run directly beside IOS XE. | Learners package a Python service and use the reservable C8000V IOx Local Manager to deploy, configure, activate, test, and remove it. |
